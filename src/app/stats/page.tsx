...
export default function StatsPage() {
  ...
  if (loading) return <div className="p-24 text-center text-sm text-[#888]">Loading in-game data...</div>;
        ...
        <div className="md:col-span-2 space-y-8 p-10 glass-card rounded-3xl shadow-2xl">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
            <div className="space-y-3">
               <p className="text-[10px] font-bold text-[#444] uppercase tracking-widest">Total Credits (MainDataStore)</p>
               <div className="bg-[#050505] border border-[#222] rounded-xl px-5 py-4 flex items-center justify-between">
                  <span className="text-2xl font-bold text-white tracking-tighter">{playerData?.coins?.toLocaleString() || "0"}</span>
                  <span className="text-[10px] font-mono text-[#333]">CR</span>
               </div>
            </div>
            <div className="space-y-3">
               <p className="text-[10px] font-bold text-[#444] uppercase tracking-widest">Tactical Asset (Weapon)</p>
               <div className="bg-[#050505] border border-[#222] rounded-xl px-5 py-4 flex items-center justify-between">
                  <span className="text-lg font-bold text-[#eaeaea] tracking-tight">{playerData?.weapon || "None"}</span>
          ...
          <div className="pt-8 border-t border-[#111] flex items-center justify-between">
            <div className="flex items-center gap-2">
               ...
               <p className="text-[11px] font-medium tracking-wide text-[#333] uppercase">Manual Override Disabled</p>
            </div>
            <div className="px-6 py-2 bg-[#111] text-[#444] text-[10px] font-bold uppercase tracking-widest rounded-lg border border-[#222] cursor-not-allowed">
              Sync Active
            </div>
          </div>
        </div>
